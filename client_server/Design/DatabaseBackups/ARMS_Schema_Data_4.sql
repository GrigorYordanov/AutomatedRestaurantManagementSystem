...
INSERT INTO ingredients_stock(name, cost, metric, calories, allergy_id, quantity ) VALUES ('pepper', 22, 1, 60, 1, 50.00 ); 
INSERT INTO ingredients_stock(name, cost, metric, calories, allergy_id, quantity ) VALUES ('carrot', 35, 1, 70, 2, 70.00 ); 
INSERT INTO ingredients_stock(name, cost, metric, calories, allergy_id, quantity ) VALUES ('tomattos', 40, 1, 50, 3, 30.00 ); 
INSERT INTO ingredients_stock(name, cost, metric, calories, allergy_id, quantity ) VALUES ('cucumbers', 24, 1, 30, 4, 10.00 ); 
INSERT INTO ingredients_stock(name, cost, metric, calories, allergy_id, quantity ) VALUES ('onion', 20, 1, 30, 1, 11.00 ); 
INSERT INTO ingredients_stock(name, cost, metric, calories, allergy_id, quantity ) VALUES ('cheese', 70, 1, 120, 2, 14.00 ); 
INSERT INTO ingredients_stock(name, cost, metric, calories, allergy_id, quantity ) VALUES ('milk', 30, 2, 20, 3, 3.00 ); 
INSERT INTO ingredients_stock(name, cost, metric, calories, allergy_id, quantity ) VALUES ('eggs', 43, 1, 20, 4, 1.00 ); 
INSERT INTO ingredients_stock(name, cost, metric, calories, allergy_id, quantity ) VALUES ('mixed meat', 25, 1, 50, 1, 12.00 ); 
INSERT INTO ingredients_stock(name, cost, metric, calories, allergy_id, quantity ) VALUES ('salami', 12, 1, 70, 2, 5.00 ); 
INSERT INTO ingredients_stock(name, cost, metric, calories, allergy_id, quantity ) VALUES ('chicken breast', 60, 1, 40, 3, 7.00 ); 
INSERT INTO ingredients_stock(name, cost, metric, calories, allergy_id, quantity ) VALUES ('beef', 53, 1, 10, 4, 8.00 ); 
INSERT INTO ingredients_stock(name, cost, metric, calories, allergy_id, quantity ) VALUES ('olive oil', 25, 2, 90, 1, 1.00 ); 
INSERT INTO ingredients_stock(name, cost, metric, calories, allergy_id, quantity ) VALUES ('salt', 10, 1, 10, 2, 12.00 ); 
INSERT INTO ingredients_stock(name, cost, metric, calories, allergy_id, quantity ) VALUES ('mixed herbs', 7, 1, 20, 3, 6.00 ); 
INSERT INTO ingredients_stock(name, cost, metric, calories, allergy_id, quantity ) VALUES ('butter', 32, 1, 60, 4, 55.00 ); 
